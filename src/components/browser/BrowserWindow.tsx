...
const BrowserWindow = ({ loaded }: BrowserWindowProps) => {
  return (
    <div className="relative w-full max-w-2xl browser-window transform transition-all duration-700 shadow-xl rounded-xl overflow-hidden">
      ...
      {/* Browser chrome */}
      <div className="bg-white rounded-t-lg border-2 border-gray-200">
        <BrowserHeader />
